...
def set_static_water_gun(
    ...
    try:
        ...
        raise HTTPException(status_code=409, detail="水枪目标未进入设备队列，请检查 S3 设备状态。") from error
...
def start_dynamic_water_gun(
    ...
    try:
        ...
        raise HTTPException(status_code=409, detail="动态模式未能启动，请检查 S3 设备状态。") from error

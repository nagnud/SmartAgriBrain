...
from position_service import PixelDetection, locate_from_vision_result, project_to_ground  # noqa: E402
...
class PositionServiceTests(unittest.TestCase):
    ...
    def test_center_ray_intersects_ground_in_front(self) -> None:
        candidate = project_to_ground(PixelDetection("苹果", 0.9, 49.0, 49.0, 2.0, 2.0), self.config)

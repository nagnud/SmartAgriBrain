...
class EdgeAssistantMessageResponse(BaseModel):
    ...
    # Values after `confirmation` are optional protocol-v2 hints. Legacy C5
    # firmware can ignore them and continue using the natural-language prompt.
    next_input: Literal["none", "duration", "confirmation", "parameter"] = "none"
    input_hint: str | None = None
    input_candidates: list[str] = Field(default_factory=list)
    dialog_version: str = "2.0"

...
void Compass::calibrateMagnetometer()
{
    ...
    while (bmm_running_) {
        ...
        if (rs == BMM350_OK) {
            ...
            sensair_sensor_update_magnetometer(mag_x, mag_y, mag_z);
...
void Compass::updateSensorData()
{
    ...
    if (rslt == BMI2_OK) {
        ...
        sensair_sensor_update_imu(acc_x_mg, acc_y_mg, acc_z_mg,
    ...
    if (mag_rslt == BMM350_OK) {
        ...
        sensair_sensor_update_magnetometer(mag_raw[0], mag_raw[1], mag_raw[2]);
